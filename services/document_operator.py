...
class DocumentOperator:
    ...
    @staticmethod
    def generate_content(prompt: str, document_context: str = "") -> str:
        """
        使用 LLM 生成文档内容
        ...
        try:
            ...
            generation_prompt = f"""
你是一个专业的文档内容生成助手。请根据以下要求生成文档内容。

**生成要求：**
{prompt}

**文档上下文：**
{document_context[:500] if document_context else "无"}
...
"""
            ...
            if provider == "zhipu":
                ...
                response = client.chat.completions.create(
                    model="glm-4.7-flash",
                    messages=[
                        {"role": "system", "content": "你是一个专业的文档内容生成助手。"},
